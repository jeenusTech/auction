...
<script>
  ...
  // const deadline = '{{$timefrom}}';
   ...
   initializeClock('clockdiv{{$auction->id}}', deadline);
});
</script>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                        ...
                        <div id="clockdiv{{$auction->id}}" class="clockdiv">
                          <div>
                    ...
                    <div class="row">
                      <div class="col">
                        <label class="auc_title_label badge badge-warning text-dark mt-2" for="time">{{$auction->auction_type=='2'?'Floor Auction':'E-auction'}}</label>
                      </div>
                    </div>
                  </div>
                </div>
